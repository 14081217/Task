...
var NPCwrodPanel = (function (_super) {
    ...
    function NPCwrodPanel() {
        ...
        this.addChild(this.cancelButton);
        this.cancelButton.addEventListener(egret.TouchEvent.TOUCH_TAP, this.oontheclose, this);
